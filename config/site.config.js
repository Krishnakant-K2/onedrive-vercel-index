...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'Krishnakant_K3@t.5tb.in',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/Krishnakant-K2/onedrive-vercel-index',
    },
    {
      name: 'Telegram',
      link: 'https://t.me/Krishnakant_Kumar',
    },
  ],
